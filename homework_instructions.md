...
1. LIRI will search Spotify for songs, Ticket Master for concerts, and OMDB for movies.

2. Make a new GitHub repository called liri-node-app and clone it to your computer.

3. To retrieve the data that will power this app, you'll need to send requests using the `axios` package to the Ticket Master, Spotify and OMDB APIs. You'll find these Node packages crucial for your assignment.
...
2. Make a JavaScript file named `liri.js`.

3. At the top of the `liri.js` file, add code to read and set any environment variables with the dotenv package:
